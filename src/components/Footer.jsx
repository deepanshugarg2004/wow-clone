...
function Footer() {
  return (
    ...
    <h1 className='text-[7vw] uppercase leading-none -mb-1 font-semibold'>EYE-</h1>
    <h1 className='text-[7vw] uppercase leading-none -mb-1 font-semibold'>OPENING</h1>
    </div>
    ...
    <div className='w-1/2'>
    <h1 className='text-[6vw] uppercase leading-none -mb-1 font-semibold'>Presentations</h1>
   
    <div className='flex justify-evenly'>
    <div className='details mt-20'>
    <a className='font-light block text-2xl mt-4 ' href="#">facebook</a>
        <a className='font-light block text-2xl mt-4 ' href="#">instagram</a>
        <a className='font-light block text-2xl mt-4 ' href="#">twitter</a>
        <a className='font-light block text-2xl mt-4 ' href="#">linkedin</a>
        <a className='font-light block text-2xl mt-4 ' href="#">behance</a>
      
    </div>

    <div className='details mt-20'>
    <a className='font-light block text-2xl mt-4 ' href="#">Home</a>
        <a className='font-light block text-2xl mt-4 ' href="#">services</a>
        <a className='font-light block text-2xl mt-4 ' href="#">Our Work</a>
        <a className='font-light block text-2xl mt-4 ' href="#">Aboutus</a>
        <a className='font-light block text-2xl mt-4 ' href="#">Insights</a>
    </div>
    </div>
